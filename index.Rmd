...
lot_plot <- side_lot_sales %>%
  ...
  my_theme + theme(legend.position = c(0.92,0.84)) +
...
district_own %>%
  ...
  #scale_fill_gradient2(name = "Number of Properties",
                      ...
                      #high = '#31044F') + 
  scale_fill_gradient(name ='test', low = '#31044F', high = '#ED9007') + my_theme +
  theme(axis.text.x = element_text(angle = 60, hjust = 1)) 
```
