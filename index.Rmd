...
blight_map <- ggplot() +
  ...
  map_theme +
  labs(title = 'High Concentration of Blight in Districts 4 and 7', subtitle = '2018 Blight Ticket Violations in Detroit', caption = 'Data Source: Detroit Data Portal') +
...
dem_map <- ggplot() +
  ...
  geom_sf_label(data = all, aes(label = count), color = 'black', size = 2) +
