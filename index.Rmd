...
colors <- c(rep('#31044F', 10), rep('#ED9007',20))
...
hist2 <- ggplot(data=non_com) + 
  ...
  annotate('rect', xmin=17850, xmax=47850, ymin= 2750, ymax=3250, color = '#6408A1', fill = NA) +
  annotate('rect', xmin=25000, xmax=55000, ymin= 1750, ymax=2250, color = "#ED9007", fill = NA) +
  annotate('text', x = 32150, y =3000, color = '#6408A1', label = 'Median Cost: ~$14,000', size=3, 
           family = my_theme$text[['family']]) +
  annotate('text', x = 40000, y =2000, color = "#ED9007", label = 'Hardest Hit Fund (HHF)\nLimit: $25,000', 
  ...
  annotate('text', x = 50000, y =1100, color = "#ED9007", 
