...
###Select Comparison of Other Demolition Programs
...
##Funding
 ...
 is the Hardest Hit Funding program and is the largest on the city’s funding sources, when this tag is used it means HHF is the likely primary source. In some instances, a house will switch to non-HHF or have city funds used to cover additional costs over the program limit of $25,000. which, by law, can be spent only in federally-designated areas of the city.
...
ggplot() +
  ...
  geom_text(data = circle_data, aes(x, y, size=count, label = Council_District)) +
  my_theme +
...
###Own It Now, Auctions, Side Lot Sales
...
ggplot(all_three, aes(x=year, y=count)) + 
  ...
  scale_y_continuous(labels=comma) +
  labs(title = 'Auctions and "Own It Now" Sales Are Increasing but Fall Behind Side Lot Sales', subtitle = 'Properties Sold through Detroit Land Bank Authority Programs Each Year', caption = 'Data Source: Detroit Open Data Portal', x='Year', y='Number of Properties Sold')
