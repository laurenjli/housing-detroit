...
map_theme <- my_theme + theme(panel.grid.major = element_line(colour = "white"))
...
dots <- data.frame('long' = c(-83.27886,-83.28137,-83.167531573, -83.17150, -83.14558), 'lat' = c(42.35133, 42.36877,42.2512935180001,42.25646,42.30114)) #other points outside of district plot area

ggplot(data = districts_shp) +
  geom_sf(aes(fill = districts)) +
  geom_point(data = blight_2018, aes(x = `Violation Longitude`, y = `Violation Latitude`), size = 0.25, 
  ...
  coord_sf(xlim = c(-83.3, -82.9), ylim = c(42.25, 42.47), expand = FALSE) +
  my_theme

#plot(st_geometry(districts_shp))
#ask alex about this, and "spatial joins"
